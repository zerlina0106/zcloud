...
import com.zlp.zerlina_cloud.domain.MailEntity;
...
public class MailSenderUtils {
	 ...
	 * @return
	 */
	public MailSenderUtils title(String title){
		mail.setTitle(title);
		return this;
	}
	 ...
	 * @return
	 */
	public MailSenderUtils content(String content)
	{
	 ...
	 * @return
	 */
	public MailSenderUtils contentType(MailContentTypeEnum typeEnum)
	{
	 ...
	 * @return
	 */
	public MailSenderUtils targets(List<String> targets)
	{

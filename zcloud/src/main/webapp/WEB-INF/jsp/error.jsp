            ...
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 text">
                    ...
                    <div class="description">
                        <br/><br/>
                        <h4>Error: </h4> <p>${pageContext.session.getAttribute("error")}</p>
                        <br/><br/>  <br/><br/>  <br/><br/>
                        <a href="login"><strong>RETURN Login</strong></a><br/>
                        <a href="index"><strong>RETURN Index</strong></a><br/>
                        <a href="register"><strong>RETURN Register</strong></a><br/>
                    </div>
                </div>
            </div>
        </div>
